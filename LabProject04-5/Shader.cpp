...
void Shader::CreateShaderVariables(ID3D12Device* Device, ID3D12GraphicsCommandList* CmdList) {}
void Shader::UpdateShaderVariables(ID3D12GraphicsCommandList* CmdList) {}
